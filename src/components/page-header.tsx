...
export function PageHeader({
  ...
  return (
    <header className="flex flex-col gap-3 pb-6 sm:flex-row sm:flex-wrap sm:items-end sm:justify-between sm:gap-4">
...
export function ModuleCard({
  ...
  const className = "group flex cursor-pointer items-center gap-4 rounded-2xl border border-border bg-card p-5 transition hover:border-mint/40 hover:bg-surface-2";
  if (to) {
    return (
