...
export const INDIA_LISTED: Listed[] = [
  ...
  {
    identifier: "BIRET",
    name: "Brookfield India Real Estate Trust REIT",
    kind: "reit",
    identifier_type: "stock_in",
    exchange: "NSE",
    currency: "INR",
  ...
  {
    identifier: "PGINVIT",
    name: "PowerGrid Infrastructure Investment Trust (InvIT)",
    kind: "invit",
    identifier_type: "stock_in",
    exchange: "NSE",
    currency: "INR",
  ...
  {
    identifier: "INDIGRID",
    name: "IndiGrid Infrastructure Trust (InvIT)",
    kind: "invit",
    identifier_type: "stock_in",
    exchange: "NSE",
    currency: "INR",
  ...
  {
    identifier: "GOLDIETF",
    name: "Nippon India Gold ETF (GoldIETF)",
    kind: "commodity",
    identifier_type: "stock_in",
    exchange: "NSE",
    currency: "INR",
  ...
  {
    identifier: "SILVERBEES",
    name: "Nippon India Silver ETF (Silver BeES)",
    kind: "commodity",
    identifier_type: "stock_in",
    exchange: "NSE",
    currency: "INR",
  ...
  {
    identifier: "USO",
    name: "United States Oil Fund (Crude Oil ETF)",
    kind: "commodity",
    identifier_type: "stock_us",
    exchange: "US",
    currency: "USD",
  ...
  {
    identifier: "DBA",
    name: "Invesco DB Agriculture Fund (Agri Commodity ETF)",
    kind: "commodity",
    identifier_type: "stock_us",
    exchange: "US",
    currency: "USD",
...
export function searchIndiaListed(query: string, kinds?: Array<Listed["kind"]>): SearchResult[] {
